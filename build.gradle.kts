...
//    implementation("io.quarkiverse.langchain4j:quarkus-langchain4j-chroma:0.18.0")
//    implementation("io.quarkiverse.langchain4j:quarkus-langchain4j-milvus:0.18.0")
//    implementation("io.quarkiverse.langchain4j:quarkus-langchain4j-easy-rag:0.18.0")
    ...
    implementation("dev.langchain4j:langchain4j-chroma:0.34.0")
    implementation("dev.langchain4j:langchain4j-milvus:0.34.0")
