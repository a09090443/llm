...
@ApplicationScoped
class SCBAugmentor(@ModelName("test") var ollamaModel: ChatLanguageModel,
                   @ModelName("test") var embeddingModel: EmbeddingModel,
                   @Named("scbMilvus") private val scbMilvusStore: EmbeddingStore<TextSegment>) : Supplier<RetrievalAugmentor> {
